...
foreach ($events as $event) {
  array_push($totalprice, $event {
    "price"});
}

foreach ($events as $event) {
  array_push($cartid, $event {
    "id"});
}
...
<div class="container text-left" >
    ...
    <div id="opt1" class="col-md-2" onclick="AddBorder(1, <?php echo sizeof($cartContents); ?>);">
      <figure  class="figure" align="center">
        <img src="src/img/maybank.png" class="figure-img img-fluid rounded" alt="A generic square placeholder image with rounded corners in a figure.">
    ...
    <div id="opt2" class="col-md-2" onclick="AddBorder(2, <?php echo sizeof($cartContents); ?>);">
      <figure class="figure" align="center">
        <img src="src/img/cimbclick.png" class="figure-img img-fluid rounded" class="center" alt="A generic square placeholder image with rounded corners in a figure.">
    ...
    <div id="opt3" class="col-md-2" onclick="AddBorder(3, <?php echo sizeof($cartContents); ?>);">
      <figure class="figure" align="center">
        <img src="src/img/visa.png" class="figure-img img-fluid rounded" class="center" alt="A generic square placeholder image with rounded corners in a figure.">
    ...
    <div id="opt4" class="col-md-2" onclick="AddBorder(4, <?php echo sizeof($cartContents); ?>);">
      <figure class="figure" align="center" >
        <img src="src/img/mastercard.png" class="figure-img img-fluid rounded" class="center" alt="A generic square placeholder image with rounded corners in a figure.">
